...
| `iconWidth` | `string` | — | Override the icon container width. Accepts any valid CSS length (e.g. `"2rem"`, `"48px"`). Defaults to `--dds-card-icon-size` (`1.5rem`). |
| `iconHeight` | `string` | — | Override the icon container height. Accepts any valid CSS length (e.g. `"2rem"`, `"48px"`). Defaults to `--dds-card-icon-size` (`1.5rem`). |
...
<Card title="Documentation" icon={<YourIcon />} iconPlacement="top-left" iconWidth="3rem" iconHeight="3rem">
