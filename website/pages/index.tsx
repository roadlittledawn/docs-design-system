...
export default function Home() {
  return (
      ...
      <CardGrid columns={4} className="mb-16">
        <Card href="/style-guide" className="h-full transition-shadow hover:shadow-md">
        ...
        <Card href="/principles" className="h-full transition-shadow hover:shadow-md">
        ...
        <Card href="/components" className="h-full transition-shadow hover:shadow-md">
        ...
        <Card href="/gallery" className="h-full transition-shadow hover:shadow-md">
