...
Great documentation can be evaluated against six core quality attributes. These aren't a checklist to apply mechanically — they're lenses for identifying where content falls short and how to improve it.

## The Six Quality Attributes

<CardGrid columns={3}>
  <Card title="Accurate">
    Information is factually correct, up-to-date, and technically precise. Code examples work as written, and statements can be verified.
  </Card>
  <Card title="Relevant">
  ...
  <Card title="Consistent">
    Terminology, formatting, tone, and style remain uniform throughout. Patterns are predictable, making content easier to navigate and understand.
  </Card>
  <Card title="Discoverable">
    Content is easy to find through search, navigation, clear titles, and proper organization. Users can locate what they need quickly.
  </Card>
</CardGrid>

## Measuring Quality Is Hard

Measuring content quality is notoriously difficult, especially at scale. These attributes are intuitive to describe but hard to quantify — "clear" to one reader may be opaque to another, and "concise" depends on how much prior knowledge the audience brings. Rather than relying on a single metric, effective measurement uses a combination of signals:
